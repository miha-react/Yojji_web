...
document.addEventListener('DOMContentLoaded', function () {
  ...
  canvas.width = document.querySelector('.canvas_holder').clientWidth;
  canvas.height = document.querySelector('.canvas_holder').clientHeight;
...
// LIFECYCLE
  ...
  function render() {
    ...
    context.beginPath(); //top of the head
    context.fillStyle = '#FF0000'; //color
    context.arc(0, car.radius * -0.68, 19, 0, Math.PI, true); // was(26)
    context.fill();

    context.beginPath(); //bottom of the head
    context.fillStyle = '#FF0000';
    context.moveTo(-19, car.radius * -0.70);
    context.lineTo(-8, 0);
    context.lineTo(8, 0);
    context.lineTo(19, car.radius * -0.70);
    context.closePath();
    context.fill();

    context.beginPath();
    context.fillStyle = '#FF0000';
    context.fillRect(-10, car.radius * -0.9 - 10, 1, -20);

    context.beginPath();
    context.fillStyle = '#FF0000';
    context.fillRect(-5, car.radius * -0.9 - 12, 1, -10);
...
// -------
  ...
  function vehicle() {
    this.radius = 29;   // body size (36)
    //this.position = new vec2(100, 200);
    this.position = new vec2(canvas.width/2, 200)
    ...
    this.render = function() {
      context.beginPath();
      context.fillStyle = '#FF0000';  //body color
...
console.log(car.position.y)
  ...
  function vec2(x = 0, y = 0) {
    ...
    this.render = function(context, ox = 0, oy = 0, color = "#A1A1A1", minLen = 42) {
